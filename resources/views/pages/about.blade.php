          ...
          <div class="about-why-sticky">
            <div class="about-why-visual" id="aboutWhyVisual">
              ...
              <div class="about-why-meta">
                <span class="about-why-count"><b id="aboutWhyCount">01</b> /
                  {{ str_pad((string) count($whyItems), 2, '0', STR_PAD_LEFT) }}</span>
            ...
            <ol class="about-why-rail" id="aboutWhyRail">
              @foreach ($whyItems as $item)
                <li><button type="button"
                    class="{{ $loop->first ? 'is-active' : '' }}">{{ str_pad((string) $loop->iteration, 2, '0', STR_PAD_LEFT) }}</button>
                </li>
              @endforeach
            </ol>
          </div>
