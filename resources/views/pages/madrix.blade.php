    ...
    <div class="wrap">
      ...
      <div class="mx-feature reveal" {!! cms_section_attr('software') !!}>
        <div class="mx-feature-copy">
          <h3 class="mx-lineup-heading"{!! cms_style($meta, 'software.heading') !!}>{!! accent_html($meta->get('software.heading')) !!}</h3>
      ...
      <div class="mx-hardware reveal" {!! cms_section_attr('hardware') !!}>
        <h3 class="mx-lineup-heading"{!! cms_style($meta, 'hardware.heading') !!}>{!! accent_html($meta->get('hardware.heading')) !!}</h3>
            ...
            <tbody>
              @foreach ($hardwareRows as $row)
                ...
                <tr>
                  <td>
                    @if ($preview !== '')
                      <span class="mx-product" data-preview="{{ $preview }}" tabindex="0"{!! cms_style($meta, 'hardware.row.product', $loop->index) !!}>{!! accent_html($row['product'] ?? '') !!}</span>
                    @else
