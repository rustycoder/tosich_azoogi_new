...
class SolutionsDefinition implements PageDefinition
{
    ...
    public function fields(): array
    {
        return [
            ...
            Field::textarea('hero.title', 'Hero title', typographic: false)->recommendedWords(4, 10),
            Field::textarea('hero.lead', 'Hero lead', typographic: false)->recommendedWords(15, 35),
            Field::text('eco.heading', 'Ecosystems heading'),
            Field::textarea('eco.lead', 'Ecosystems lead')->recommendedWords(8, 25),
            ...
            Field::textarea('eco.cta.body', 'Eco CTA body')->recommendedWords(10, 25),
            ...
            Field::textarea('sector.item.body', 'Sector body', true, 'sector.item')->recommendedWords(15, 40),
