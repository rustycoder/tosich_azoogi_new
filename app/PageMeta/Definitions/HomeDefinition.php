...
class HomeDefinition implements PageDefinition
{
    ...
    public function fields(): array
    {
        ...
        return [
            Field::text('slide.eyebrow', 'Slide eyebrow', $slide, $group, typographic: false)->recommendedWords(1, 4),
            Field::textarea('slide.title', 'Slide title', $slide, $group, typographic: false)->recommendedWords(4, 10),
            Field::textarea('slide.subtitle', 'Slide subtitle', $slide, $group, typographic: false)->recommendedWords(10, 25),
            ...
            Field::text('intro.kicker', 'Intro kicker', typographic: false)->recommendedWords(1, 3),
            Field::text('intro.heading', 'Intro heading', typographic: false)->recommendedWords(6, 16),
            Field::text('values.kicker', 'Values kicker')->recommendedWords(1, 3),
            Field::textarea('values.heading', 'Values heading')->recommendedWords(4, 12),
            Field::text('values.card.title', 'Value title', true, 'values.card')->recommendedWords(2, 6),
            Field::textarea('values.card.body', 'Value body', true, 'values.card')->recommendedWords(15, 35),
